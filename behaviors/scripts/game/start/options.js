...
export function gameStartOptions(player) {
    const form = new ActionFormData()
        ...
        .body("§7Pick how you want to start the game. Clicking an option will begin the process of starting right after.")
...
function gameSelect() {
    ...
    system.runTimeout(() => {
        ...
        world.getPlayers().forEach((players) => players.playSound("note.flute"));

        system.runTimeout(() => {
            world.getPlayers().forEach((players) => {
                players.onScreenDisplay.setTitle(gameInPlay(), { stayDuration: 120, fadeInDuration: 3, fadeOutDuration: 20, });
