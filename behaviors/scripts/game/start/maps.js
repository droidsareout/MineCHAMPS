import { system, world, StructureAnimationMode, InputPermissionCategory } from "@minecraft/server";

export function dashBiomeMania() {
    world.structureManager.place("Dash_BiomeMania", world.getDimension("overworld"), { x: -31, y: -64, z: 39 }, {
    ...
    system.runTimeout(() => {
        world.getPlayers().forEach((player) => {
            if (player.hasTag("optedIn") === false || player.hasTag("inGame") === false) return;
            ...
            system.runTimeout(() => {
                ...
                system.runTimeout(() => {
                    player.onScreenDisplay.setTitle("§7Starting game in", { stayDuration: 160, fadeInDuration: 10, fadeOutDuration: 10, })
