...
export function mapInPlay() {
    const participants = world.scoreboard.getObjective("mapInPlay").getParticipants();
...
export function gameInPlay() {
    const participants = world.scoreboard.getObjective("gameInPlay").getParticipants();
    let participantNames = participants.map((participant) => participant.displayName);
    
    for (const name of participantNames) {
        let playing = world.scoreboard.getObjective("gameInPlay").getScore(name);
