    ...
    for (const player of world.getPlayers()) {
        ...
        try {
            if (time >= 18000 && time <= 24000) {
                ...
                dimension.runCommand(`setblock 46 -43 -12 waxed_copper_bulb["lit"=false]`)
                dimension.runCommand(`setblock 59 -43 -11 waxed_copper_bulb["lit"=false]`)
                dimension.runCommand(`setblock -49 -44 57 waxed_copper_bulb["lit"=false]`)
                dimension.runCommand(`setblock -47 -42 62 waxed_copper_bulb["lit"=false]`)
                dimension.runCommand(`setblock 25 -44 105 waxed_copper_bulb["lit"=false]`)
            };
        } catch (error) {
